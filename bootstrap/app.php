...
return Application::configure(basePath: dirname(__DIR__))
    ...
    ->withMiddleware(function (Middleware $middleware) {
        ...
        $middleware->alias([
            ...
            'sacco.member' => \App\Modules\Sacco\Http\Middleware\SaccoMemberMiddleware::class,
            'sacco.member.api' => \App\Modules\Sacco\Http\Middleware\CheckSaccoMembershipApi::class,
