...
class SettingsController extends Controller
{
    ...
    private function getGeneralSettings()
    {
        return [
            ...
            'podcasts_enabled' => $this->getStoredSetting('general', 'podcasts_enabled', false, 'boolean'),
            'promotions_enabled' => $this->getStoredSetting('general', 'promotions_enabled', false, 'boolean'),
            'sacco_enabled' => $this->getStoredSetting('general', 'sacco_enabled', false, 'boolean'),
